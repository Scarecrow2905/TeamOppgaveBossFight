function viewBosses() {
    ...
    for (let index = 0; index < 3; index++) {
        ...
        <div class="center">
            ...
            <div class="boss-name">Boss: ${model.boss[index].name}</div>

            <div class="boss-hp">HP: ${model.boss[index].health}</div>

            <div class="boss-dmg">DMG: ${model.boss[index].damage}</div>
...
function viewPlayer() {
    ...
    for (let index = 0; index < model.player.length; index++) {
        ...
        <div class="center">
            ...
            <div class="player-name">${model.player[index].name}</div>
            <div class="player-hp">HP: ${model.player[index].health}</div>
            <div class="player-dmg">DMG: ${model.player[index].damage}</div>
...
function viewFight() {
    ...
    <div class="center">
        <div class="boss-info">
            <h2><div class="boss-name">Boss: ${model.boss[chosenBoss].name}</div></h2>
            <div class="boss-hp">HP:<progress id="bosshealth" value="${model.boss[chosenBoss].health}" max="${model.boss[chosenBoss].maxhealth}"></progress>${model.boss[chosenBoss].health} </div>
            <div class="boss-dmg"> DMG: ${model.boss[chosenBoss].damage} </div>
        ...
        <div class="player">
            <div class="player-info">
                ...
                <div class="player-hp">
                HP:<progress id="playerhealth"value="${model.player[chosenPlayer].health}" max="${model.player[chosenPlayer].maxhealth}">
                </progress>${model.player[chosenPlayer].health}
